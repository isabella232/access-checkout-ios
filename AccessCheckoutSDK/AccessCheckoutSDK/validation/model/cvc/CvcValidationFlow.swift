...
class CvcValidationFlow {
     ...
     */
    init(cvcValidator: CvcValidator, cvcValidationStateHandler: CvcValidationStateHandler, validationRule: ValidationRule) {
        self.cvcValidator = cvcValidator
        self.cvcValidationStateHandler = cvcValidationStateHandler
        self.validationRule = validationRule
    }
    
    init(cvcValidator: CvcValidator, cvcValidationStateHandler: CvcValidationStateHandler, cvc: String, validationRule: ValidationRule) {
        self.cvcValidator = cvcValidator
        self.cvcValidationStateHandler = cvcValidationStateHandler
        self.cvc = cvc
        self.validationRule = validationRule
